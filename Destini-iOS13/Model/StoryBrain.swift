...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice: String?) -> Story {
        ...
        if let choice = userChoice {
            ...
            let actualStory = stories[indexChoice]
            
            if actualStory.choice1 == choice {
                indexChoice = actualStory.choice1Destination
            } else {
                indexChoice = actualStory.choice2Destination
            }
        }
        
        return stories[indexChoice]
    }
}
